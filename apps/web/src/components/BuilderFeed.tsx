  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex items-center gap-2 mb-5">
        {/* X — active */}
        <button className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-white/10 border border-white/20 text-white text-sm font-medium transition-colors">
        ...
        <div className="relative group">
          <button disabled className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-white/8 text-white/25 text-sm font-medium cursor-not-allowed select-none">
            <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="currentColor">
            ...
            TikTok
            <span className="text-[10px] px-1.5 py-0.5 bg-white/5 border border-white/10 rounded-full text-white/30 ml-0.5">soon</span>
          </button>
        </div>
